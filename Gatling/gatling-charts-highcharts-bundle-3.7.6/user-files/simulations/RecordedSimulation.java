...
public class RecordedSimulation extends Simulation {

  {
    ...
    headers_0.put("Accept", "application/json, text/javascript, */*; q=0.01");
    headers_0.put("Accept-Encoding", "gzip, deflate");
    headers_0.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_0.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    headers_0.put("X-Requested-With", "XMLHttpRequest");
    
    Map<CharSequence, String> headers_2 = new HashMap<>();
    headers_2.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_35 = new HashMap<>();
    headers_35.put("Origin", "http://automationpractice.com");
    headers_35.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_53 = new HashMap<>();
    headers_53.put("Accept", "text/css,*/*;q=0.1");
    headers_53.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_54 = new HashMap<>();
    headers_54.put("Accept", "text/css,*/*;q=0.1");
    headers_54.put("Accept-Encoding", "gzip, deflate");
    headers_54.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_54.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_56 = new HashMap<>();
    headers_56.put("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9");
    headers_56.put("Accept-Encoding", "gzip, deflate");
    headers_56.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_56.put("Upgrade-Insecure-Requests", "1");
    headers_56.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_57 = new HashMap<>();
    headers_57.put("Accept", "*/*");
    headers_57.put("Accept-Encoding", "gzip, deflate");
    headers_57.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_57.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_65 = new HashMap<>();
    headers_65.put("Origin", "http://automationpractice.com");
    headers_65.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    headers_65.put("sec-ch-ua", " Not A;Brand\";v=\"99\", \"Chromium\";v=\"98\", \"Google Chrome\";v=\"98");
    headers_65.put("sec-ch-ua-mobile", "?0");
    headers_65.put("sec-ch-ua-platform", "Linux");
    
    Map<CharSequence, String> headers_66 = new HashMap<>();
    headers_66.put("Accept", "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8");
    headers_66.put("Accept-Encoding", "gzip, deflate");
    headers_66.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_66.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    
    Map<CharSequence, String> headers_73 = new HashMap<>();
    headers_73.put("Accept", "application/json, text/javascript, */*; q=0.01");
    headers_73.put("Accept-Encoding", "gzip, deflate");
    headers_73.put("Accept-Language", "en-GB,en-US;q=0.9,en;q=0.8");
    headers_73.put("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
    headers_73.put("Origin", "http://automationpractice.com");
    headers_73.put("User-Agent", "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36");
    headers_73.put("X-Requested-With", "XMLHttpRequest");
    
    String uri2 = "https://fonts.gstatic.com/s/opensans/v28/memvYaGs126MiZpBA-UvWbX2vVnXBbObj2OVTS-muw.woff2";
    
    String uri3 = "http://fonts.googleapis.com/css";
